---
title: "5% Tax (RAS) on Corporate Rentals: 2026 Guide"
date: "2026-03-15"
...
category: "tax-law"
keyTakeaways:
  - "Companies in Morocco are legally obligated to withhold tax (RAS) on rental payments made to individuals, acting as intermediaries for the tax administration."
  - "The standard withholding rates for 2026 are 10% for annual rents below 120,000 MAD and 15% for those above that threshold."
  - "A specific 5% rate applies to certain share transfers in real estate companies and specific service contracts under the latest Finance Law updates."
  - "Failure to declare and pay the withheld tax by the 20th of the following month results in an immediate 15% penalty plus monthly interest."
  - "Rental payments to other companies (legal entities) are generally not subject to withholding at source, provided a valid VAT invoice is issued."
faq:
  - question: "What is the 5% RAS in Morocco for 2026?"
    answer: "The 5% Withholding Tax (RAS) primarily applies to specific professional services, public procurement contracts, and the transfer of shares in non-listed real estate companies as per Finance Law updates. For standard rentals to individuals, the rates are typically 10% or 15% depending on the annual amount."
  - question: "Who is responsible for paying the rental tax?"
    answer: "When the tenant is a company (legal entity) and the landlord is an individual, the company is legally responsible for withholding the tax from the rent and paying it to the DGI. If the tenant is an individual, the landlord is responsible for declaring and paying their own tax."
  - question: "How do I calculate the withholding tax if the rent is 'Net'?"
    answer: "You must 'gross up' the amount. For a 10% RAS, divide the net amount by 0.9. For a 15% RAS, divide the net amount by 0.85. The tax is then calculated on this higher gross figure."
  - question: "Are there any exemptions for the 5% or 10% RAS?"
    answer: "Yes, if the landlord is a company subject to Corporate Tax (IS) or an individual who has opted for a professional tax regime and provides a valid tax exemption certificate, the tenant does not need to withhold tax at the source."
  - question: "What happens if I miss the 20-day deadline for payment?"
    answer: "Late payments trigger a 15% penalty on the tax amount due, plus a 5% increase for the first month of delay and an additional 0.50% for every subsequent month or fraction thereof."
  - question: "Does the 5% RAS apply to Airbnb or short-term corporate rentals?"
    answer: "Short-term rentals for business purposes are subject to the same RAS rules if the owner is an individual. However, if the platform handles the billing or the owner is a registered company, the tax treatment follows the rules for commercial services."
---
...
1.  **CGI Article 45**: This article defines the nature of "Rental Income" (Revenus Fonciers). It establishes that income derived from the leasing of built or unbuilt properties and agricultural land falls under this category.
2.  **CGI Article 157 & 160**: These articles govern the obligations of "Third-Party Payers." When a legal entity (a company) pays rent to an individual, the law shifts the responsibility of tax collection from the landlord to the tenant.
3.  **Finance Law 2023 & 2025 Reforms**: As seen in **[Reference 3]** and **[Reference 2]**, the Moroccan legislator has refined how distributions from Real Estate Investment Vehicles (OPCI) are taxed, reducing the allowance to 40% only when these vehicles open their capital to the public.
4.  **Finance Law 2026 (Projected/Contextualized)**: Building on the trajectory of **[Reference 5]**, the 5% rate is increasingly applied to specific professional services and corporate interactions to ensure a minimum tax contribution.
5.  **Law 67.12**: While a civil law, this governs the mandatory written rental contracts which serve as the underlying legal proof for any tax withholding.
...
### Required Documents
To ensure your [tax compliance](/blog/tax-compliance-morocco-business-guide) is bulletproof, maintain the following:
1.  The registered lease agreement.
2.  Proof of monthly payment (bank transfer receipts).
3.  The "Quittance de loyer" (Rent receipt) signed by the landlord.
4.  The electronic filing confirmation from the SIMPL-IR portal.
...
The law requires the RAS to be calculated on the **Gross Amount**. If your contract says "10,000 MAD net of tax," you must "gross up" the calculation. Paying 10% on the net amount results in an underpayment, which will be caught during a [business tax audit](/blog/business-tax-amnesty-morocco-2026).
