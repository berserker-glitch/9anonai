---
title: "5% Taxe (RAS) sur locations: Guide entreprises 2026"
date: "2026-03-15"
...
category: "tax-law"
keyTakeaways:
  - "La retenue à la source (RAS) est obligatoire pour toutes les entreprises versant des loyers à des personnes physiques dépassant 30 000 MAD par an."
  - "Le taux de 5 % introduit par les récentes réformes vise spécifiquement certaines prestations de services et actes juridiques, distincts des revenus fonciers classiques."
  - "Tout retard de versement de la RAS (au-delà du mois suivant le paiement) entraîne des pénalités automatiques de 15 % plus des intérêts moratoires."
  - "La déductibilité fiscale des loyers pour une entreprise dépend de l'enregistrement correct du contrat et du respect des plafonds de paiement en espèces fixés par la LF 50.25."
  - "La gestion de la RAS est entièrement dématérialisée via la plateforme SIMPL, rendant le croisement des données fiscales immédiat pour l'administration."
faq:
  - question: "Qui doit payer la taxe de 5 % sur les locations au Maroc en 2026 ?"
    answer: "La taxe (RAS) doit être prélevée et versée par l'entreprise locataire (personne morale) lorsqu'elle paie des prestations de services ou des loyers spécifiques à des tiers, conformément aux articles du CGI et aux réformes de la Loi de Finances 2026."
  - question: "Quelle est la différence entre la RAS de 5 % et celle de 10 % ?"
    answer: "Le taux de 5 % s'applique généralement aux prestations de services techniques ou professionnels, tandis que le taux de 10 % (ou 15 %) concerne les revenus fonciers bruts versés à des particuliers dont le montant annuel dépasse certains seuils."
  - question: "Peut-on payer le loyer en espèces pour éviter la RAS ?"
    answer: "Non, la Loi de Finances 50.25 limite strictement les paiements en espèces. Un paiement non bancarisé peut entraîner la non-déductibilité de la charge et des amendes, sans dispenser l'entreprise de son obligation de retenue à la source."
  - question: "Quel est le délai pour verser la retenue à la source à la DGI ?"
    answer: "L'entreprise dispose d'un délai allant jusqu'à la fin du mois suivant celui du paiement du loyer ou de la prestation pour déclarer et verser la RAS via le portail SIMPL."
  - question: "Une association est-elle obligée d'opérer la retenue à la source ?"
    answer: "Oui, au regard du droit fiscal marocain, les associations sont assimilées à des personnes morales et ont l'obligation de pratiquer la RAS sur les loyers et services qu'elles règlent à des tiers."
  - question: "Que faire si le propriétaire refuse la retenue à la source ?"
    answer: "L'obligation légale pèse sur l'entreprise. En cas de refus, l'entreprise doit tout de même verser la taxe à l'État, sous peine d'être solidairement responsable du paiement et des amendes lors d'un contrôle fiscal."
---
...
Un contrat de bail non enregistré auprès de la DGI peut entraîner le rejet de la déductibilité du loyer en tant que charge. De plus, la [numérisation de l'enregistrement immobilier](/blog/real-estate-digital-registration-morocco-2026) en 2026 rend désormais automatique le croisement des données entre le service de l'enregistrement et celui de l'IR/IS.
