---
title: "50% Capital Gains: Retirement Relief (2026 Morocco)"
date: "2026-03-15"
...
category: "tax-law"
keyTakeaways:
  - "The 50% capital gains relief in 2026 is primarily applied to the taxable profit base for long-term assets and specific retirement-related property transfers."
  - "Retiring civil servants can purchase state-owned housing with a 50% down payment and 120-month installments under Decree Article 7."
  - "Article 65 of the Finance Law defines taxable profit as the sale price minus the acquisition price and documented investment costs."
  - "Sellers must file their capital gains tax declaration within 30 days of the sale to avoid a minimum 15% penalty."
  - "Primary residences held for more than six years are generally exempt from capital gains tax, providing the ultimate retirement relief."
faq:
  - question: "Does the 50% relief apply to all property sales in Morocco?"
    answer: "No, the 50% relief typically applies to the taxable profit of secondary properties or professional assets held for a specific duration, or as a transitional measure under the Finance Law. Primary residences held for over 6 years are usually 100% exempt."
  - question: "What documents do I need to prove renovation costs for tax deduction?"
    answer: "You must provide 'Factures Normalisées' (standardized invoices) that include the contractor's ICE (Identifiant Commun de l'Entreprise), IF (Identifiant Fiscal), and address. Simple receipts or cash vouchers are not accepted by the DGI."
  - question: "Can I pay my capital gains tax in installments?"
    answer: "Generally, capital gains tax (TPI) must be paid in full at the time of the sale. However, retired state employees purchasing state-owned property can pay the purchase price in installments after an initial 50% deposit."
  - question: "What happens if I don't declare my sale within 30 days?"
    answer: "Failure to declare within the 30-day window results in automatic late payment penalties and interest. The tax administration may also perform an ex-officio assessment of the property's value, which is often higher than the actual sale price."
  - question: "Is the sale of a business (Fonds de Commerce) eligible for retirement relief?"
    answer: "Yes, business owners can benefit from specific tax treatments when liquidating assets for retirement, but they must follow Article 120 of the Commercial Code to separate equipment, goods, and goodwill for tax purposes."
---
...
For more information on digital procedures, see our guide on [real estate digital registration in Morocco 2026](/blog/real-estate-digital-registration-morocco-2026).
...
Always remember that tax laws are subject to the annual **Loi de Finances**. What holds true in early 2026 might be adjusted by year-end. Consulting with a legal expert or using a [legal AI assistant in Morocco](/blog/legal-ai-assistant-morocco-guide) can help you stay updated on the latest circulars from the DGI.
